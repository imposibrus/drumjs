...
(function() {
    ...
    var Drum = function(selector, options) {
        ...
        var init = function() {
            ...
            var element = selector instanceof String ? document.querySelector(selector) : selector;
                    ...
                    if ( !interval ) {
                        interval = setInterval(function (argument) {
                            ...
                            if ( !isDragging && Math.pow(v,2) < 0.001 ) {
                                ...
                                interval = null;
                            } else if ( !isDragging && Math.pow(v,2) < .5 && Math.pow(settings.rotation - getNearest(),2) < .1 ) {
